...
**Plans** compares the lineup, applies promo codes, and lists codes this workspace has redeemed. On a paid plan each card also prices the switch before you commit, showing what is due today and when the next bill lands.
